...
public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  /*设置各个控件的展示内容*/
      Log.i("xxxxxxx",""+(new ExpressTakeService()).SearchExpressTake(Integer.parseInt(mData.get(position).get("expressTakeObj").toString())).getTaskTitle());
	  holder.tv_expressTakeObj.setText("代拿的快递：" + (new ExpressTakeService()).SearchExpressTake(Integer.parseInt(mData.get(position).get("expressTakeObj").toString())).getTaskTitle());
