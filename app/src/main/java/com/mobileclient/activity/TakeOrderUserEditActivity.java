...
public class TakeOrderUserEditActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.takeorder_user_edit); 
			...
			public void onClick(View v) {
				try {
					...
					if(ET_takeTime.getText().toString().equals("")) {
						Toast.makeText(TakeOrderUserEditActivity.this, "接单时间输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_ssdt.getText().toString().equals("")) {
						Toast.makeText(TakeOrderUserEditActivity.this, "实时动态输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_evaluate.getText().toString().equals("")) {
						Toast.makeText(TakeOrderUserEditActivity.this, "用户评价输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传代拿订单信息*/
					TakeOrderUserEditActivity.this.setTitle("正在更新代拿订单信息，稍等...");
