...
public class KechengbiaoActivity extends Activity {
    ...
    private static  String[] userType_ShowText  = null;
...
//        spinner_userType = (Spinner) findViewById(R.id.Spinner_userType);
       // userType_ShowText = new String[]{"普通用户","快递员"};
        // 将可选内容与ArrayAdapter连接起来
      //  userType_adapter = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item, userType_ShowText);
        // 设置下拉列表的风格
     //   userType_adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        // 将adapter 添加到spinner中
     //   spinner_userType.setAdapter(userType_adapter);
        // 添加事件Spinner事件监听
    //    spinner_userType.setOnItemSelectedListener(new OnItemSelectedListener() {
        //    @Override
         //   public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
//                View TR_auth = findViewById(R.id.TR_auth);
//                View TR_authFile = findViewById(R.id.TR_authFile);
//                if(arg2 == 0) {
//                    userInfo.setUserType("普通用户");
//                    userInfo.setShenHeState("已审核");
//                    TR_auth.setVisibility(View.GONE);
//                    TR_authFile.setVisibility(View.GONE);
//                }
//                else {
//                    userInfo.setUserType("快递员");
//                    userInfo.setShenHeState("待审核");
//                    TR_auth.setVisibility(View.VISIBLE);
//                    TR_authFile.setVisibility(View.VISIBLE);
//                }
...
//                intent.setClass(KechengbiaoActivity.this,photoListActivity.class);
...
//        ET_address = (EditText) findViewById(R.id.ET_address);
        ...
        btn_authFile.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent intent = new Intent();
                intent.setClass(KechengbiaoActivity.this,fileListActivity.class);
...
//                        Toast.makeText(KechengbiaoActivity.this, "用户名输入不能为空!", Toast.LENGTH_LONG).show();
...
//                        Toast.makeText(KechengbiaoActivity.this, "登录密码输入不能为空!", Toast.LENGTH_LONG).show();
...
//                        Toast.makeText(KechengbiaoActivity.this, "姓名输入不能为空!", Toast.LENGTH_LONG).show();
...
//                        Toast.makeText(KechengbiaoActivity.this, "性别输入不能为空!", Toast.LENGTH_LONG).show();
...
//                        KechengbiaoActivity.this.setTitle("正在上传图片，稍等...");
//                        String userPhoto = HttpUtil.uploadFile(userInfo.getUserPhoto());
//                        KechengbiaoActivity.this.setTitle("图片上传完毕！");
...
//                        Toast.makeText(KechengbiaoActivity.this, "联系电话输入不能为空!", Toast.LENGTH_LONG).show();
...
//                        Toast.makeText(KechengbiaoActivity.this, "邮箱输入不能为空!", Toast.LENGTH_LONG).show();
...
//                        Toast.makeText(KechengbiaoActivity.this, "家庭地址输入不能为空!", Toast.LENGTH_LONG).show();
//                        ET_address.setFocusable(true);
//                        ET_address.requestFocus();
//                        return;
//                    }
//                    userInfo.setAddress(ET_address.getText().toString());
                  ///  if(userInfo.getKechengbiao()!= null) {
                        //如果文件地址不为空，说明用户选择了文件，这时需要连接服务器上传文件
                     //   KechengbiaoActivity.this.setTitle("正在上传课程表，稍等...");
                   //     String kechengbiao= HttpUtil.uploadFile(userInfo.getKechengbiao());
                    //    KechengbiaoActivity.this.setTitle("课程表上传完毕！");
                   //     userInfo.setKechengbiao(kechengbiao);
                    //} else {
                        //Toast.makeText(getApplicationContext(), "请先选择认证文件", 1).show();
                        //return;
                   //     userInfo.setKechengbiao("");
                   // }

                    userInfo.setRegTime("--");
                    /*调用业务逻辑层上传用户信息*/
                    KechengbiaoActivity.this.setTitle("正在上传，稍等...");
