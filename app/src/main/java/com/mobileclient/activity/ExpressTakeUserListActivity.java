...
public class ExpressTakeUserListActivity extends Activity {
...
//				intent.setClass(ExpressTakeUserListActivity.this, ExpressTakeQueryActivity.class);
...
//		});
		...
		tvSearchRlt.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				Intent intent = new Intent(ExpressTakeUserListActivity.this,SearchActivity.class);
...
//		});
		...
		if(intent.getIntExtra("q",0)==1) {
			Log.i("zhu666","查询");
			queryConditionExpressTake = (ExpressTake) intent.getExtras().getSerializable("queryConditionExpressTake");
			if (intent.getExtras().get("query").equals("query")) {
				...
				Log.i("zhu999",""+queryConditionExpressTake.getTaskTitle());
				setViews();
			}
		}
		//if(){
	...
	private void setViews() {
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new ExpressTakeSimpleAdapter(ExpressTakeUserListActivity.this, list,
		...
		lv.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
            	...
            	Intent intent = new Intent();
            	intent.setClass(ExpressTakeUserListActivity.this, ExpressTakeDetailActivity.class);
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == 0) {  //编辑快递代拿信息
			...
			Intent intent = new Intent();
			intent.setClass(ExpressTakeUserListActivity.this, ExpressTakeEditActivity.class);
			Bundle bundle = new Bundle();
			bundle.putInt("orderId", orderId);
	...
	protected void dialog() {
		Builder builder = new Builder(ExpressTakeUserListActivity.this);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < expressTakeList.size(); i++) {
				...
				Log.i("bbbbbbbb",""+expressTakeList.get(i).getTaskTitle());
				map.put("companyObj", expressTakeList.get(i).getCompanyObj());
				Log.i("cccccccccccc",""+expressTakeList.get(i).getCompanyObj());
				map.put("waybill", expressTakeList.get(i).getWaybill());
				Log.i("cccccccccccc",""+expressTakeList.get(i).getWaybill());
