...
public class UserInfoRegisterActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btn_authFile.setOnClickListener(new OnClickListener() { 
			...
			public void onClick(View arg0) {
				Intent intent = new Intent();
				intent.setClass(UserInfoRegisterActivity.this,fileListActivity.class);
		...
		btnAdd.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				try {
					...
					//Toast.makeText(getApplicationContext(), result, 1s).show();
