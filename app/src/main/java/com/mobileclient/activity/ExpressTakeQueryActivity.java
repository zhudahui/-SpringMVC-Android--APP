	...
	private  void init() {
		final Handler myHandler=new Handler(){
			...
			public void handleMessage(Message msg) {
				...
				if(msg.what==0x123){
					int companyCount = msg.getData().getInt("size");
					Log.i("zhu3333",""+companyCount);
					...
					companyObj_adapter = new ArrayAdapter<String>(ExpressTakeQueryActivity.this,android.R.layout.simple_spinner_item, companyObj_ShowText);
					// 设置物流公司下拉列表的风格
