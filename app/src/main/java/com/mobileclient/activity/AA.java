...
//        PackageManager.PERMISSION_DENIED  拒绝权限
                ...
                new AlertDialog.Builder(this).setTitle("title")
                        .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                // 请求授权
                                ActivityCompat.requestPermissions(AA.this,new String[]{Manifest.permission.CAMERA},1);
                            }
    ...
    private void ImgUpdateDirection(String filepath) {
        ...
        try {
            ...
            if (orc_bitmap != null) {
                circleImageView.setImageBitmap(orc_bitmap);
            }
        } catch (IOException e) {
            e.printStackTrace();
            exif = null;
    ...
    private void uploadImage(String imagePath) {
        ...
        new AA.NetworkTask().execute(imagePath);
    }
    ...
    class NetworkTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            if(!"error".equals(result)) {
                Log.i(TAG, "图片地址 " + HttpUtil.IP + result);
                Glide.with(AA.this)
                        .load(HttpUtil.IP + result)
                ;
            }
        }
    }
...
//        builder.addFormDataPart("userId", "20160519142605");
        ...
        Request request = reqBuilder
                .url(HttpUtil.IP + "/upload")
                .build();
        Log.d(TAG, "请求地址 " + HttpUtil.IP+ "/upload");
        try{
