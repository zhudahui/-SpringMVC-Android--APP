 ...
 */
public class ExpressRoute extends Activity implements OnMapClickListener,GeocodeSearch.OnGeocodeSearchListener, OnClickListener,
...
//		getIntentData();
    ...
    private void registerListener() {
        aMap.setOnMapClickListener(ExpressRoute.this);
        aMap.setOnMarkerClickListener(ExpressRoute.this);
        aMap.setOnInfoWindowClickListener(ExpressRoute.this);
        aMap.setInfoWindowAdapter(ExpressRoute.this);
            ...
            if (result != null && result.getGeocodeAddressList() != null
                ...
                if(address != null) {
                    ...
                    addressName = "经纬度值:" + lon1 + "\n位置描述:"
                            + lat1;
                    ToastUtil.show(ExpressRoute.this, addressName);
                    searchRouteResult(ROUTE_TYPE_WALK, RouteSearch.WalkDefault);
                    //mWalk.setImageResource(R.drawable.route_walk_select);
                    mapView.setVisibility(View.VISIBLE);
                    mBusResultLayout.setVisibility(View.GONE);
                ...
                ToastUtil.show(ExpressRoute.this, R.string.no_result);
            }
        } else {
...
//            //    getLatlon(String.valueOf(esdt.getText()));
//                break;
//            d/efault:
//                break;
//        }
