	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnEvaluate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				final EditText inputServer = new EditText(TakeOrderDetailActivity.this);
				AlertDialog.Builder builder = new AlertDialog.Builder(TakeOrderDetailActivity.this);
