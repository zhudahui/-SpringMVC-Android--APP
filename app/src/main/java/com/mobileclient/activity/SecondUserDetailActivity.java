...
public class SecondUserDetailActivity extends Activity implements View.OnClickListener{
    private static final String TAG = "uploadImage";
    private IdentityImageView userPhoto;
    private TextView userName,userPhone,userGender,userEmail,nickName,userId,studentId,userMoney,userAuthfile,userReputation,regTime,userType1,userPassword;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // 设置当前Activity界面布局
        setContentView(R.layout.second_user_detail);
...
//========================================================================
        ...
        btnDown.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SecondUserDetailActivity.this.setTitle("正在开始下载认证文件....");
...
//                                // 请求授权
//                                ActivityCompat.requestPermissions(SecondUserDetailActivity.this,new String[]{Manifest.permission.CAMERA},1);
//                            }
