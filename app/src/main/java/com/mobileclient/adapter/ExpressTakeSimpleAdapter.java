...
public class ExpressTakeSimpleAdapter extends SimpleAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		com.mobileclient.adapter.ExpressTakeSimpleAdapter.ViewHolder holder = null;
		///*第一次装载这个view时=null,就新建一个调用inflate渲染一个view*/
		if (convertView == null) convertView = mInflater.inflate(R.layout.order_list_item, null);
		convertView.setTag("listViewTAG" + position);
		holder = new com.mobileclient.adapter.ExpressTakeSimpleAdapter.ViewHolder();
		/*绑定该view各个控件*/
		...
		holder.receiveAdressName=convertView.findViewById(R.id.receiveAddressName);
